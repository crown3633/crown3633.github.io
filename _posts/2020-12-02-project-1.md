...
def get_car_categories():
    ...
    print("Done\n")
    return Counter(d)
    #Counter 메서드는 list나 dict형 변수에서 같은 key 값들의 갯수를 세는 역할을 하며, dict의 경우 value 값이 높은 것부터 순차적으로 정렬됨
```  
- 해당 디렉토리에 있는 input 이미지에 대해 top5 class와 probability를 구해서 누적 합산하는 함수.
- 결국, 디렉토리 내에 있는 이미지 파일들 중 가장 빈번하게 등장하는 class들을 찾기 위함<br>
```python
...
<div style="width:300px; height:700px; float:left; margin-right:10px;">
 <img src="/assets/img/failed_img1" width="300px" height="700px">
</div>
<div style="width:300px; height:700px; float:left;">
 <img src="/assets/img/damaged.jpg" width="300px" height="700px">
</div><div style="clear:both;"></div><br>
