...
<a href="#Gate1>- Gate 1. 이미지 데이터의 차량 여부 판단(Pre-trained VGG16 model)</a>
<a href="#Gate2>- Gate 2. 차량의 파손 여부 판단(직접 학습한 VGGNet model)</a> <br><br>
...
#### <a name="Gate2">Gate 2. 차량의 파손 여부 판단(직접 학습한 VGGNet model)</a>
