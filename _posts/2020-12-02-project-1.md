...
----------
 ...
 - **Step**
 1. 이미지 데이터의 차량 여부 판단(Pre-trained model)
...
![Image Alt 텍스트](/assets/img/Gate.png){: width="700" height="300" text-aling="center"}
*모델 알고리즘 개략도*
...
- data2 폴더 : Training data 600개(Normal/Damaged 각 300개)
	             Validation data 200개(Normal/Damaged 각 100개)
<br><br>
#### 2. 데이터 전처리 과정
