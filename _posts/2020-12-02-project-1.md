...
3. [VGGNet Model](#3.-VGGNet-Model) <br><br>
 
4. [Details](#4.-Details)
- 이미지 데이터의 차량 여부 판단(Pre-trained VGG16 model)
- 차량의 파손 여부 판단(직접 학습한 VGGNet model)<br><br>

5. [Evaluation](#5.-Evaulation)<br><br>

6. [Conclusion & Improvement](#6.-Conclusion-&-Improvement)<br><br>
 
7. [Reference](#7.-Reference)<br><br>
...
#### Gate 1.이미지 데이터의 차량 여부 판단(Pre-trained VGG16 model)
- Gate 1은 Normal/Damaged car를 구분하기 전에 Input image가 차량인지 아닌지를 구별하기 위함
...
<img src="/assets/img/get_prediction.png" width="700px" height="30px">
...
- get_car_categories로 얻은 list중 key값이 큰 순서대로 상위 50개를 선택하여 car_categories에 저장
<div style="width:700px; height:30px; float:left;">
 <img src="/assets/img/car_categories.png" width="700px" height="30px">
...
<img src="/assets/img/failed_img.png" width="500px" height="60px">

- Failed_img 확인
<div style="width:300px; height:700px; float:left; margin-right:10px;">
 <img src="/assets/img/failed_img1.png" width="300px" height="700px">
</div>
<div style="width:300px; height:700px; float:left;">
 <img src="/assets/img/failed_img2.png" width="300px" height="700px">
</div><div style="clear:both;"></div><br>

- Failed_img 예측 결과 확인
<div style="width:300px; height:500px; float:left; margin-right:10px;">
 <img src="/assets/img/failed_pred1.png" width="300px" height="500px">
</div>
<div style="width:300px; height:500px; float:left;">
 <img src="/assets/img/failed_pred2.png" width="300px" height="500px">
</div><div style="clear:both;"></div><br>
