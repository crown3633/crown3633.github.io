...
![Image Alt 텍스트](/assets/img/pred_top5.png){: width="1000" height="50"}

- 변수 preds는 dataset(data1 폴더) resizing 후 Pre-trained model인 VGG16으로 예측한 결과물이며, 1000개의 class에 대한 확률값을 나타내었기에 차원은 (1,1000)이다.<br>get_prediction 함수는 예측한 class 중 상위 5개의 class name과 확률값을 반환한다.
