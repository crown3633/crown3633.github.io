...
- 하지만 극히 드물게 failed_img와 같이 여러 사물이 있는 경우, 혹은 차량의 일부만 나온 경우는 인식하지 못하는 경우가 있다.

- Failed_img 예측 결과 확인
<div style="width:150px; height:300px; float:left; margin-right:10px;">
 <img src="/assets/img/failed_pred1.png" width="150px" height="150px">
</div>
<div style="width:150px; height:300px; float:left;">
 <img src="/assets/img/failed_pred2.png" width="200px" height="150px">
</div><div style="clear:both;"></div><br>
